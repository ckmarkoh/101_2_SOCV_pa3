/****************************************************************************
  ...
  Synopsis     [ V3 Network for SoCV BDD. ]
  Author       [ Cheng-Yin Wu ]
...
void V3Ntk::buildNtkBdd() {
  ...
  // put your own code in PA2 here
  Msg(MSG_WAR) << "Function buildNtkBdd() is not available! BDDs were not constructed." << endl;
}

void V3Ntk::buildBdd(const V3NetId& netId) {
  // TODO: build BDD for the specified net here
  // put your own code in PA2 here
  Msg(MSG_WAR) << "Function buildBdd(const V3NetId&) is not available! BDDs were not constructed." << endl;
}
