...
const uint32_t dfsNtkForGeneralOrder(V3Ntk* const, V3NetVec&, const bool& = false);
const uint32_t dfsNtkForSimulationOrder(V3Ntk* const, V3NetVec&, const bool& = false);
const uint32_t dfsNtkForReductionOrder(V3Ntk* const, V3NetVec&, const V3NetVec&, const bool& = false);
// General DFS Fanin Cone Marking Functions for V3 Ntk
void dfsMarkFaninCone(V3Ntk* const, const V3NetId&);
void dfsMarkFaninCone(V3Ntk* const, const V3NetId&, const V3BoolVec&);
void dfsRecurMarkFaninCone(V3Ntk* const, const V3NetId&);
