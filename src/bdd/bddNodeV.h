...
private:
   ...
   // MODIFICATION FOR SoCV BDD, for free style memeber functions
   const void* socv_func_1(vector<void*> arg_vec) const;
   const void* socv_func_2(vector<void*> arg_vec) const;
   const void* socv_func_3(vector<void*> arg_vec) const;
   const void* socv_func_4(vector<void*> arg_vec) const;
};
